import{d,$ as u,y as h,b as a,e as t,x as s,A as r,F as f,Z as v,o as n,a0 as g,l as x,g as b}from"../modules/vue-BjrCXWg9.js";import{u as y,j as N,c as m,b as k}from"../index-Dx5_U4Q7.js";import{N as T}from"./NoteDisplay-uqkMfM5a.js";import"../modules/shiki-D-EsxFNX.js";const w={id:"page-root"},C={class:"m-4"},D={class:"mb-10"},H={class:"text-4xl font-bold mt-2"},L={class:"opacity-50"},V={class:"text-lg"},B={class:"font-bold flex gap-2"},S={class:"opacity-50"},j=t("div",{class:"flex-auto"},null,-1),A={key:0,class:"border-main mb-8"},F=d({__name:"print",setup(M){const{slides:p,total:_}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
